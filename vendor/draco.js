// vendor/draco.js — pure-JavaScript Draco mesh decoder (no WASM).
// Vendored from mrdoob/draco.js (https://github.com/mrdoob/draco.js), MIT License,
// Copyright (c) 2026 Mr.doob — itself a clean-room port of Google Draco (Apache-2.0).
// TRIMMED for ProofFront: the three.js `import` and the trailing three.js `DRACOLoader`
// wrapper are removed; only the framework-agnostic core decoder is kept, with ESM exports
// added at the bottom. Decodes glTF KHR_draco_mesh_compression (bitstream 2.2, EdgeBreaker
// + sequential, triangular meshes). Lazy-loaded by core/gl/gltf.js only when a Draco
// primitive is encountered. Do not edit — re-vendor from upstream instead.
...
export { Decoder, DecoderBuffer, Mesh, EncodedGeometryType };
